...
class SpaNotification extends StatefulWidget {
  const SpaNotification({ Key? key }) : super(key: key);

  @override
  _SpaNotificationState createState() => _SpaNotificationState();
}

class _SpaNotificationState extends State<SpaNotification> {
  @override
  ...
  text: TextSpan(
    ...
    children: <TextSpan>[
      TextSpan(text: ' yoiu upcoming appointment\n with therapist ', style: TextStyle( color: Colors.black ,fontSize: 14),),
  ...
  text: TextSpan(
    ...
    children: <TextSpan>[
      TextSpan(text: ' Get Discounts by admin', style: TextStyle( color: Colors.black ,fontSize: 14),),
