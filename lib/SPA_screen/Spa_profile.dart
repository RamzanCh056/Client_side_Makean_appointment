...
class SpaProfile extends StatefulWidget {
  const SpaProfile({ Key? key }) : super(key: key);

  @override
  _SpaProfileState createState() => _SpaProfileState();
}

class _SpaProfileState extends State<SpaProfile> {
                  ...
                  child: Container(
                     ...
                     Column(children: [
                       ...
                       GestureDetector(
                         ...
                         height: 130,
                         width: 150,
                            child:   _imagefile ==null? Image.asset('images/spa.png', fit: BoxFit.fill, ) : Image.file(File(_imagefile!.path)),
