...
class Notuficatoin_page extends StatefulWidget {
  const Notuficatoin_page({ Key? key }) : super(key: key);

  @override
  _Notuficatoin_pageState createState() => _Notuficatoin_pageState();
}

class _Notuficatoin_pageState extends State<Notuficatoin_page> {
  @override
